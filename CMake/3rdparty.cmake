...
if(DCMTK_USE_FIND_PACKAGE)
  ...
  if(DCMTK_WITH_ICONV)
    if(WITH_LIBICONVINC)
      ...
      if(EXISTS "${LIBICONV_LIBDIR}/libiconv_d.lib" AND EXISTS "${LIBICONV_LIBDIR}/libiconv_o.lib")
        set(LIBICONV_LIBS debug "${LIBICONV_LIBDIR}/libiconv_d.lib" optimized "${LIBICONV_LIBDIR}/libiconv_o.lib")
      elseif(EXISTS "${LIBICONV_LIBDIR}/libiconv.lib")
        set(LIBICONV_LIBS "${LIBICONV_LIBDIR}/libiconv.lib")
        if(EXISTS "${LIBICONV_LIBDIR}/libcharset.lib")
          list(APPEND LIBICONV_LIBS "${LIBICONV_LIBDIR}/libcharset.lib")
        endif()
      else()
        set(LIBICONV_LIBS "")
      endif()
      if(LIBICONV_LIBS)
        ...
        message(STATUS "Warning: ICONV support will be disabled because libiconv libraries were not found in ${LIBICONV_LIBDIR}.")
        set(DCMTK_WITH_ICONV OFF CACHE BOOL "" FORCE)
        set(WITH_LIBICONV "")
      endif()
    else() # turn off library if library path not set
